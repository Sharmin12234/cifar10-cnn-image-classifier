...
* **Pixel Vector Scaling:** Normalizes raw pixel values from $[0, 255]$ directly into an optimized $[0, 1]$ mathematical distribution. This prevents immediate gradient explosion and stabilizes backpropagation weights.
...
* **Confusion Matrix:** Constructs an $N \times N$ mapping table tracking true classes against model classifications to visually expose subtle target vulnerabilities.
